...
<html>
    ...
    <form action="MainController" method="POST">
        ...
        totalStudents: <input type="number" name="totalStudents" value="${u.totalStudents}"/> <br/>
        totalFaculties: <input type="number" name="totalFaculties" value="${u.totalFaculties}"/> <br/>
